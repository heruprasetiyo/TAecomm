                        ...
                        <?php echo form_open_multipart('backend/Crud/tambah_aksi');?>
                            <div class="card-body">
                              ...
                              <div class="form-group">
                                ...
                                <input type="radio" name="category" value="1"> Mobil MPV</input><br>
                                <input type="radio" name="category" value="2"> Mobil Hatchback</input><br>
                                <input type="radio" name="category" value="3"> Mobil Convertible</input>
                              </div>
                              <div class="form-group">
